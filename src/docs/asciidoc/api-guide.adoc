...
include::{snippets}/brands/update/request-parts.adoc[]
...
include::{snippets}/products/create/request-parts.adoc[]
...
include::{snippets}/products/update/request-parts.adoc[]
